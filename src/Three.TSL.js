...
export const BRDF_EON = TSL.BRDF_EON;
...
export const EON_DirectionalAlbedo = TSL.EON_DirectionalAlbedo;
...
export const diffuseRoughness = TSL.diffuseRoughness;
...
export const materialDiffuseRoughness = TSL.materialDiffuseRoughness;
